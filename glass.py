# -*- coding: utf-8 -*-
"""
Created on Wed Dec 11 15:40:37 2019
...
glass = pd.read_csv("file:///E:/excelr/course/assignment/knn/glass.csv")
...
# train accuracy 
train_acc = np.mean(neigh.predict(train.iloc[:,1:9])==train.iloc[:,9]) # 94 %

# test accuracy
test_acc = np.mean(neigh.predict(test.iloc[:,1:9])==test.iloc[:,9]) # 100%
